...
class ChartService:
    ...
    def get_equity_curve(self, start_date: str | None, end_date: str | None) -> EquityCurveResponse:
        ...
        cash_flow_curve = self._build_net_cost_curve(account_id, effective_end)
    ...
    def _build_net_cost_curve(self, account_id: str | None, effective_end: date) -> list[tuple[str, float]]:
        if not account_id:
            return []
